...
**TODO** If the flow is changed to be `< totalContributionRate[user]`, it should either revert or give up ownership of all licenses.
...
- **TODO** All of the user's licenses are up for auction
